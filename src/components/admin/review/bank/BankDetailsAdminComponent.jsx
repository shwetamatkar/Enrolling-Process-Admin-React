...
function BankAdminComponent(props) {
  const { data, formRules, loadingPost, formFields } = props;
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 12, color: "#757575" }}>
        Note: Kindly Approve Bank Proof document before approving this form.
      </p>
    </div>
  );
}

BankAdminComponent.defaultProps = {
  userData: {}
};
