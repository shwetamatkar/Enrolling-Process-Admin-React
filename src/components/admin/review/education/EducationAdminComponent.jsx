...
function EducationAdminComponent(props) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 12, color: "#757575" }}>
        Note: Kindly Approve Education Proof Document before approving this
        form.
      </p>
    </div>
  );
...
EducationAdminComponent.defaultProps = {
  userData: {}
};
...
export default EducationAdminComponent;
